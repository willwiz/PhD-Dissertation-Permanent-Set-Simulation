...
%---    INTRODUCTION
\input{Chapters/chapter3-content/chapter3.1.tex}

%---    Experimental methods and data post-processing
\input{Chapters/chapter3-content/chapter3.2.tex}

%---    Delineation and modelling of the tissue-level mechanical effects of exogenous cross-links
\input{Chapters/chapter3-content/chapter3.3.tex}

%---    Initial model formulation
\input{Chapters/chapter3-content/chapter3.4.tex}

%---    Model simplifications and parameter estimation
\input{Chapters/chapter3-content/chapter3.5.tex}

%---    primary results
\input{Chapters/chapter3-content/chapter3.6.tex}

%---    discussion
\input{Chapters/chapter3-content/chapter3.7.tex}

\input{Chapters/chapter3-content/nomenclature.tex}
